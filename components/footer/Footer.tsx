...
import { Link, NavItem } from "components";
export const Footer = () => {
  return (
        ...
        <div className=" px-4 py-10 md:py-20">
          ...
          <div className="max-w-6xl mx-auto flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between md:items-center mt-8">
            ...
            <div>
              <p>
                Developed by
                <div className="inline-block transform hover:scale-105 hover:-rotate-3 transition duration-300">
                  <div className="hover:bg-indigo-500 rounded-md px-2 py-1  hover:text-gray-50">
